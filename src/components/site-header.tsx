...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-white">
      <div className="container mx-auto flex h-16 max-w-screen-2xl items-center px-6 shadow-sm">
            ...
            (navItem, i) =>
              navItem.href && (
                <Link
                  key={i}
                  href={navItem.href}
                  className={`text-muted-foreground hover:text-foreground/80 flex items-center transition-colors
